...
def fetch_and_clean():
    ...
    # 预先生成空文件，防止 Nginx 报 404
    for fname in ["cn_tw.txt", "tv_v4.txt"]:
        with open(f"{prefix}{fname}", "w", encoding="utf-8") as f:
            f.write("列表正在抓取更新中, #genre#\n")
